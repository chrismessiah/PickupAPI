...
namespace DotNetApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkNpgsql().AddDbContext<IpsumDbContext>(options => options.UseNpgsql(connectionString));
            // *********** CONFIGURES POSTRES FOR GIVEN CONTEXTS VIA DEP. INJ. *********
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IpsumDbContext context)
        {
